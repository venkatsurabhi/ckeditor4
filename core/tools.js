 ...
 */
CKEDITOR.tools.arrayCompare = function( arrayA, arrayB ) {
	if ( !arrayA && !arrayB )
		return true;
 ...
 */
CKEDITOR.tools.getIndex = function( arr, compareFunction ) {
 ...
 */
CKEDITOR.tools.clone = function( obj ) {
	var clone;
 ...
 * @returns {String}
 */
CKEDITOR.tools.capitalize = function( str, keepCase ) {
 ...
 */
CKEDITOR.tools.prototypedCopy = function( source ) {
	var copy = function() {};
 ...
 */
CKEDITOR.tools.copy = function( source ) {
	var obj = {},
		name;
 ...
 * @returns {Boolean}
 */
CKEDITOR.tools.isEmpty = function( object ) {
	for ( var i in object ) {
 ...
 */
CKEDITOR.tools.cssStyleToDomStyle = ( function() {
 ...
 */
CKEDITOR.tools.htmlDecode = function( text ) {
	// See:
 ...
 */
CKEDITOR.tools.htmlEncodeAttr = function( text ) {
 ...
 */
CKEDITOR.tools.htmlDecodeAttr = function( text ) {
...
/**
		...
		*/
CKEDITOR.tools.transformPlainTextToHtml = function( text, enterMode ) {
 ...
 */
CKEDITOR.tools.getNextNumber = ( function() {
	var last = 0;
	return function() {
		return ++last;
	};
 ...
 */
CKEDITOR.tools.getNextId = function() {
 ...
 */
CKEDITOR.tools.getUniqueId = function() {
 ...
 */
CKEDITOR.tools.override = function( originalFunction, functionBuilder ) {
 ...
 */
CKEDITOR.tools.throttle = function( minInterval, output, contextObj ) {
 ...
 */
CKEDITOR.tools.indexOf = function( array, value ) {
 ...
 */
CKEDITOR.tools.search = function( array, value ) {
 ...
 */
CKEDITOR.tools.bind = function( func, obj ) {
 ...
 */
CKEDITOR.tools.createClass = function( definition ) {
	var $ = definition.$,
 ...
 * {@link #addFunction}.
 */
CKEDITOR.tools.removeFunction = function( ref ) {
	functions[ ref ] = null;
};
 ...
 */
CKEDITOR.tools.callFunction = function( ref ) {
 ...
 */
CKEDITOR.tools.cssLength = ( function() {
 ...
 */
CKEDITOR.tools.convertToPx = ( function() {
	var calculator;
 ...
 * @returns {String}
 */
CKEDITOR.tools.repeat = function( str, times ) {
 ...
 */
CKEDITOR.tools.defer = function( fn ) {
	return function() {
		var args = arguments,
			self = this;
 ...
 */
CKEDITOR.tools.normalizeCssText = function( styleText, nativeNormalize ) {
	var props = [],
		name,
 ...
 */
CKEDITOR.tools.objectCompare = function( left, right, onlyLeft ) {
	var name;
 ...
 */
CKEDITOR.tools.objectKeys = function( obj ) {
 ...
 */
CKEDITOR.tools.convertArrayToObject = function( arr, fillWith ) {
	var obj = {};
 ...
 */
CKEDITOR.tools.getStyledSpans = function( property, source ) {
 ...
 */
CKEDITOR.tools.fixDomain = function() {
	var domain;
 ...
 */
CKEDITOR.tools.eventsBuffer = function( minInterval, output, contextObj ) {
 ...
 * @since 4.4.0
 */
CKEDITOR.tools.checkIfAnyArrayItemMatches = function( arr, regexp ) {
	for ( var i = 0, l = arr.length; i < l; ++i ) {
 ...
 * @since 4.4.0
 */
CKEDITOR.tools.checkIfAnyObjectPropertyMatches = function( obj, regexp ) {
	for ( var i in obj ) {
		if ( i.match( regexp ) )
			return true;
	}
 ...
 */
CKEDITOR.tools.keystrokeToString = function( lang, keystroke ) {
 ...
 */
CKEDITOR.tools.keystrokeToArray = function( lang, keystroke ) {
 ...
 * @readonly
 */
CKEDITOR.tools.transparentImageData = 'data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==';
 ...
 * @returns {String}
 */
CKEDITOR.tools.getCookie = function( name ) {
	name = name.toLowerCase();
 ...
 * @param {String} value
 */
CKEDITOR.tools.setCookie = function( name, value ) {
 ...
 */
CKEDITOR.tools.escapeCss = function( selector ) {
	// Invalid input.
	if ( !selector ) {
		return '';
	}
 ...
 */
CKEDITOR.tools.getMouseButton = function( evt ) {
 ...
 */
CKEDITOR.tools.normalizeMouseButton = function( button, reverse ) {
 ...
 */
CKEDITOR.tools.convertHexStringToBytes = function( hexString ) {
	var bytesArray = [],
 ...
 */
CKEDITOR.tools.convertBytesToBase64 = function( bytesArray ) {
...
=======
>>>>>>> 9bdaa5e7c... Move color definition to Color, solved depends issue
			}
		}
 ...
 */
CKEDITOR.tools.getAbsoluteRectPosition = function( window, rect ) {
